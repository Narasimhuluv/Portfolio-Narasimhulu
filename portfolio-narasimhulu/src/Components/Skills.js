 ...
 return (
  <section className="skills">
   <div className="container">
    ...
    >
     {/* Skills and line */}
     <div data-aos="fade-left" className="flex items_center skill_line">
     ...
     <article className="flex items_center justify_center skills_article column">
      <figure className="flex_33 skill_figure" data-aos="zoom-out">
      ...
      <div
       className={
        isDark === false
         ? "flex_42 flex justify_center flex_wrap items_center logos_parent_div"
         : "flex_42 flex justify_center flex_wrap items_center logos_parent_div logos_parent_dark_div"
       }
      >
       ...
       <img className="skill_image" src="/images/vue.svg" alt="" />
       <img className="skill_image" src="/images/sass.svg" alt="" />
       <img className="skill_image" src="/images/tailwindcss.svg" alt="" />
       <img className="skill_image" src="/images/materialui.svg" alt="" />
       <img className="skill_image" src="/images/github.png" alt="" />
      </div>
     </article>
    </div>
   </div>
