   ...
   <div className="container">
    ...
    >
     ...
     >
      ...
      <div className="project_article_semidiv">
       <p className="summery">
        ...
        unlimited access. Your membership fee supports Casey Botticello and the
      ...
      <div className="flex icons">
       <ul className="flex_15 flex justify_center ">
        ...
        {/* <li>
         <a
          href="https://blog-application-six.vercel.app/users/login"
          target="blank"
         >
     ...
     >
      ...
      <div className="project_article_semidiv">
       <p className="summery">
        This project is a "Github Battle" app. You'll be able to see the most
        popular repos for a variety of languages as well as battle two Github
        users
       </p>
      </div>
      <ul className="flex project_list">
      ...
      <div className="flex icons">
       <ul className="flex_15 flex justify_center ">
        ...
        <li>
         <a href="https://github-battle-using-hooks.vercel.app/" target="blank">
          <OpenInNewRoundedIcon />
         </a>
        </li>
       </ul>
     ...
     >
      ...
      <div className="project_article_semidiv">
       <p className="summery">
        ...
        display the all list of products and we can filter the products size
        wise and sort the prices, we can add the products in cart
       </p>
      </div>
      <ul className="flex project_list">
       <li>ReactJs</li>
      ...
      <div className="flex icons">
       <ul className="flex_15 flex justify_center ">
        ...
        <li>
         <a href="https://shopping-cart-using-hooks.vercel.app/" target="blank">
          <OpenInNewRoundedIcon />
         </a>
        </li>
       </ul>
     ...
     >
      ...
      <div className="project_article_semidiv">
       <p className="summery">
        ...
        Movies on internet-connected devices
       </p>
      </div>
      <ul className="flex project_list">
       <li>ReactJs</li>
     ...
     >
      ...
      <div className="project_article_semidiv">
       <p className="summery">
        Amazon Videos is small application inspired from Amazon prime.There is
        data Fetch by using API and it will take us to the Individual movies or
        series of details when we click on specific movie or series.
       </p>
      </div>
      <ul className="flex project_list">
       <li>ReactJs</li>
