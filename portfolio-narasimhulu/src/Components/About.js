    ...
    >
     ...
     <article className="flex items_center justify_center column">
      <div className="flex_42 about_data">
       <p>
        Hello! I'm <span className="name">Narasimhulu Vasam</span> , from
        Kadapa(D), AndhraPradesh, also known as YSR District , AndhraPradesh.
       </p>
       <p>
        I am a creative, time punctual, dedicated, goal-oriented individual with
        decent moral Values and Ethicates along with a high-energy level, honed
       ...
       <p>
        ...
        ) , Kadapa, AndhraPradesh in Specialization of Commerce (2018-2020).
       </p>
       ...
       <div className="flex_33">
        ...
        <div className="flex_30 contact_data">
         <article className="flex items_center">
          <img data-aos="fade-right" src="/images/profile.jpeg" alt="" />
          ...
          <a
           className="resume"
           href="./assets/Vasam_Frontend_and_FullStack_Resume.pdf"
           download
          >
           Resume
          </a>
